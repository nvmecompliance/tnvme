...
bool
AllPciRegs_r10a::ValidateDefaultValues()
{
...
bool
AllPciRegs_r10a::ValidateROBitsAfterWriting()
{
    ULONGLONG value;
    const PciSpcType *pciMetrics = gRegisters->GetPciMetrics();
    const vector<PciCapabilities> *pciCap = gRegisters->GetPciCapabilities();
...
int
AllPciRegs_r10a::ReportOffendingBitPos(ULONGLONG val, ULONGLONG expectedVal)
{
    ULONGLONG bitMask;
...
bool
AllPciRegs_r10a::ValidatePciCapRegisterROAttribute(PciSpc reg)
{
    ULONGLONG value;
...
bool
AllPciRegs_r10a::ValidatePciHdrRegisterROAttribute(PciSpc reg)
{
    ULONGLONG value;
    ULONGLONG expectedValue;
    const PciSpcType *pciMetrics = gRegisters->GetPciMetrics();
