...
{
    int rc;
    struct rw_generic io = { regSpc, roffset, rsize, BYTE_LEN,
        (unsigned char *)&value };

    // Override access type to conform to register size.
    switch (rsize)
    {
...
{
    int rc;
    struct rw_generic io = { regSpc, roffset, rsize, BYTE_LEN, value };
