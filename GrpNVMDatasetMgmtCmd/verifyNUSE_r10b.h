...
#ifndef _VERIFYNUSE_r10b_H_
#define _VERIFYNUSE_r10b_H_
...
public:
     ...
     */
    virtual VerifyNUSE_r10b *Clone() const
        { return new VerifyNUSE_r10b(*this); }
    VerifyNUSE_r10b &operator=(const VerifyNUSE_r10b &other);
    VerifyNUSE_r10b(const VerifyNUSE_r10b &other);
