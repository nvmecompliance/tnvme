...
#include "namespaceAttach.h"


SharedNamespaceAttachPtr NamespaceAttach::NullNamespaceAttachPtr;
const uint8_t NamespaceAttach::Opcode = 0x15;
...
NamespaceAttach::~NamespaceAttach()
{
}
