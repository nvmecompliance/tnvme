...
#ifndef _DELETEALLATONCE_r10b_H_
...
public:
     ...
     */
    virtual DeleteAllAtOnce_r10b *Clone() const
        { return new DeleteAllAtOnce_r10b(*this); }
    DeleteAllAtOnce_r10b &operator=(const DeleteAllAtOnce_r10b &other);
    DeleteAllAtOnce_r10b(const DeleteAllAtOnce_r10b &other);
