...
FunctionalityMeta_r10b::FunctionalityMeta_r10b(int fd,
    ...
    Test(fd, mGrpName, mTestName, SPECREV_10b, errRegs)
{
    ...
    mTestDesc.SetShort(     "Verify flush functionality for meta namspcs");
...
FunctionalityMeta_r10b::~FunctionalityMeta_r10b()
{
    ///////////////////////////////////////////////////////////////////////////
...
FunctionalityMeta_r10b(const FunctionalityMeta_r10b &other) :
    Test(other)
{
    ///////////////////////////////////////////////////////////////////////////
...
FunctionalityMeta_r10b &
FunctionalityMeta_r10b::operator=(const FunctionalityMeta_r10b
    &other)
{
    ///////////////////////////////////////////////////////////////////////////
    // All pointers in this object must be NULL, never allow shallow or deep
...
void
FunctionalityMeta_r10b::CreateIOQs(SharedASQPtr asq, SharedACQPtr acq,
...
void
FunctionalityMeta_r10b::ResizeDataBuf(SharedReadPtr &readCmd,
