...
#ifndef _COMPLETIONQINVALID_r10b_H_
#define _COMPLETIONQINVALID_r10b_H_
...
public:
     ...
     */
    virtual CompletionQInvalid_r10b *Clone() const
        { return new CompletionQInvalid_r10b(*this); }
    CompletionQInvalid_r10b &operator=(const CompletionQInvalid_r10b &other);
    CompletionQInvalid_r10b(const CompletionQInvalid_r10b &other);
