...
#ifndef _ACCEPTQPRIORITY_r10b_H_
#define _ACCEPTQPRIORITY_r10b_H_
...
public:
     ...
     */
    virtual AcceptQPriority_r10b *Clone() const
        { return new AcceptQPriority_r10b(*this); }
    AcceptQPriority_r10b &operator=(const AcceptQPriority_r10b &other);
    AcceptQPriority_r10b(const AcceptQPriority_r10b &other);
