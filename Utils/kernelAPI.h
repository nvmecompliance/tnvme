...
public:
     ...
     */
    static void DumpKernelMetrics(LogFilename filename);
     ...
     */
    static void DumpCtrlrSpaceRegs(LogFilename filename, bool verbose = true);
    static void DumpPciSpaceRegs(LogFilename filename, bool verbose = true);
