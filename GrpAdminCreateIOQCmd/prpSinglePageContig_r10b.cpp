...
PRPSinglePageContig_r10b::PRPSinglePageContig_r10b(int fd,
    ...
    Test(fd, mGrpName, mTestName, SPECREV_10b, errRegs)
{
    ...
    mTestDesc.SetShort(     "Create IOQ's backed by contigous memory = 1 page");
    ...
    mTestDesc.SetLong(
        ...
        "QID = 1, num elements = Y, where Y = (CC.MPS / CC.IOCQES), where "
        "CC.IOCQES = Identify.CQES_b3:0; backed by contig memory. Issue a "
        "CreateIOSQ cmd, with QID = 1, num elements = Z, where Z = "
        "(CC.MPS / CC.IOSQES), where CC.IOSQES = Identify.SQES_b3:0; "
...
PRPSinglePageContig_r10b::~PRPSinglePageContig_r10b()
{
    ///////////////////////////////////////////////////////////////////////////
...
PRPSinglePageContig_r10b::
PRPSinglePageContig_r10b(const PRPSinglePageContig_r10b &other) :
    Test(other)
{
    ///////////////////////////////////////////////////////////////////////////
...
PRPSinglePageContig_r10b &
PRPSinglePageContig_r10b::operator=(const PRPSinglePageContig_r10b
    &other)
{
    ///////////////////////////////////////////////////////////////////////////
    // All pointers in this object must be NULL, never allow shallow or deep
...
Test::RunType
PRPSinglePageContig_r10b::RunnableCoreTest(bool preserve)
{
...
void
PRPSinglePageContig_r10b::RunCoreTest()
{
    /** \verbatim
     * Assumptions:
     * None
...
void
PRPSinglePageContig_r10b::VerifyDataPat(SharedReadPtr readCmd,
