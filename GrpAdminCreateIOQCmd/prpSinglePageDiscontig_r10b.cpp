    ...
    Test(grpName, testName, SPECREV_10b)
{
    ...
    mTestDesc.SetLong(
        ...
        "CC.IOCQES = Identify.CQES_b3:0; backed by discontig memory. Issue "
        "a CreateIOSQ cmd, with QID = 1, num elements = Z, where Z = "
        "(CC.MPS / CC.IOSQES), where CC.IOSQES = Identify.SQES_b3:0; backed "
        "by discontig memory. Issue X write cmds, where X = "
...
PRPSinglePageDiscontig_r10b::
PRPSinglePageDiscontig_r10b(const PRPSinglePageDiscontig_r10b &other) :
    Test(other)
{
    ///////////////////////////////////////////////////////////////////////////
...
PRPSinglePageDiscontig_r10b &
PRPSinglePageDiscontig_r10b::operator=(const PRPSinglePageDiscontig_r10b
    &other)
{
    ///////////////////////////////////////////////////////////////////////////
    // All pointers in this object must be NULL, never allow shallow or deep
...
void
PRPSinglePageDiscontig_r10b::VerifyDataPat(SharedReadPtr readCmd,
