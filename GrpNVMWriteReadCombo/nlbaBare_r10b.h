...
#ifndef _NLBABARE_r10b_H_
#define _NLBABARE_r10b_H_
...
public:
     ...
     */
    virtual NLBABare_r10b *Clone() const
        { return new NLBABare_r10b(*this); }
    NLBABare_r10b &operator=(const NLBABare_r10b &other);
