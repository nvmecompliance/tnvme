...
#ifndef _PRPOFFSETSINGLEPGSINGLEBLK_r10b_H_
...
public:
     ...
     */
    virtual PRPOffsetSinglePgSingleBlk_r10b *Clone() const
        { return new PRPOffsetSinglePgSingleBlk_r10b(*this); }
    PRPOffsetSinglePgSingleBlk_r10b &operator=
        (const PRPOffsetSinglePgSingleBlk_r10b &other);
