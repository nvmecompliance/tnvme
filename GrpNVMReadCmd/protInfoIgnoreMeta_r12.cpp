...
ProtInfoIgnoreMeta_r12::ProtInfoIgnoreMeta_r12(
    string grpName, string testName) :
    Test(grpName, testName, SPECREV_12)
{
    // 63 chars allowed:     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    mTestDesc.SetCompliance("revision 1.2, section 6");
    ...
    mTestDesc.SetLong(
        ...
        "read cmds where each is reading 1 data block at LBA 0 and approp "
...
ProtInfoIgnoreMeta_r12::
ProtInfoIgnoreMeta_r12(const ProtInfoIgnoreMeta_r12 &other) : Test(other)
{
    ///////////////////////////////////////////////////////////////////////////
...
Test::RunType
ProtInfoIgnoreMeta_r12::RunnableCoreTest(bool preserve)
{
    ///////////////////////////////////////////////////////////////////////////
...
void
ProtInfoIgnoreMeta_r12::RunCoreTest()
{
    /** \verbatim
     * Assumptions:
     * 1) None.
    ...
    for (size_t i = 0; i < meta.size(); i++) {
        ...
        if (namSpcPtr->isZeroFilled()) {
            ...
            LOG_NRM("Get LBA format and lba data size for namespc #%d",
                meta[i]);
            ...
            Informative::NamspcType nsType = gInformative->IdentifyNamespace(
                namSpcPtr);
            switch (nsType) {
            ...
            for (uint16_t protInfo = 0; protInfo <= 0x0f; protInfo++) {
                ...
                context = str(
                    boost::format("ns%d.protInfo0x%02X") % (uint32_t)i
                        % protInfo);
...
void
ProtInfoIgnoreMeta_r12::CreateIOQs(SharedASQPtr asq, SharedACQPtr acq,
