...
LBAOutOfRangeMeta_r12::LBAOutOfRangeMeta_r12(
    string grpName, string testName) :
    Test(grpName, testName, SPECREV_12)
{
    // 63 chars allowed:     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    mTestDesc.SetCompliance("revision 1.2, section 4,6");
...
LBAOutOfRangeMeta_r12::
LBAOutOfRangeMeta_r12(const LBAOutOfRangeMeta_r12 &other) : Test(other)
{
    ///////////////////////////////////////////////////////////////////////////
...
Test::RunType
LBAOutOfRangeMeta_r12::RunnableCoreTest(bool preserve)
{
    ///////////////////////////////////////////////////////////////////////////
...
void
LBAOutOfRangeMeta_r12::RunCoreTest()
{
    /** \verbatim
     * Assumptions:
     * None.
    ...
    for (size_t i = 0; i < meta.size(); i++) {
        ...
        if (namSpcPtr->isZeroFilled()) {
            ...
            LOG_NRM(
                "Determine namspc type and allocate meta buffer as necesssary");
...
void
LBAOutOfRangeMeta_r12::SendCmdToHdw(SharedSQPtr sq, SharedCQPtr cq,
...
void
LBAOutOfRangeMeta_r12::CreateIOQs(SharedASQPtr asq, SharedACQPtr acq,
