...
#define FIRST_RSV_LID       0x04
#define MAX_LID             0xBF
#define RSV_NOTIF_LID       0x80
#define NUMD                1

namespace GrpAdminGetLogPgCmd {


InvalidLogPageNVMSet_r11b::InvalidLogPageNVMSet_r11b
...
InvalidLogPageNVMSet_r11b::
InvalidLogPageNVMSet_r11b(const InvalidLogPageNVMSet_r11b &other) : Test(other)
{
    ///////////////////////////////////////////////////////////////////////////
...
InvalidLogPageNVMSet_r11b &
InvalidLogPageNVMSet_r11b::operator=(const InvalidLogPageNVMSet_r11b &other)
{
    ///////////////////////////////////////////////////////////////////////////
    // All pointers in this object must be NULL, never allow shallow or deep
    // copies, see Test::Clone() header comment.
...
Test::RunType
InvalidLogPageNVMSet_r11b::RunnableCoreTest(bool preserve)
{
    ///////////////////////////////////////////////////////////////////////////
...
void
InvalidLogPageNVMSet_r11b::RunCoreTest()
{
    /** \verbatim
     * Assumptions:
...
list<uint32_t>
InvalidLogPageNVMSet_r11b::GetInvalidLIDs()
{
    list<uint32_t> invalidLIDs;

    invalidLIDs.push_back(0);
    for (uint32_t lid = FIRST_RSV_LID; lid < RSV_NOTIF_LID ; lid++)
        invalidLIDs.push_back(lid);
    for (uint32_t lid = RSV_NOTIF_LID + 1; lid <= MAX_LID ; lid++)
        invalidLIDs.push_back(lid);
