...
AllCtrlRegs_r11::AllCtrlRegs_r11(string grpName, string testName) :
    Test(grpName, testName, SPECREV_11), AllCtrlRegs_r10b(grpName, testName)
{
    // 63 chars allowed:     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    mTestDesc.SetCompliance("revision 1.1, section 3");
...
AllCtrlRegs_r11::~AllCtrlRegs_r11()
{
    ///////////////////////////////////////////////////////////////////////////
...
AllCtrlRegs_r11::AllCtrlRegs_r11(const AllCtrlRegs_r11 &other) :
...
Test::RunType
AllCtrlRegs_r11::RunnableCoreTest(bool preserve)
{
    ///////////////////////////////////////////////////////////////////////////
