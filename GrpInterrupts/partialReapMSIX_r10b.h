...
#ifndef _PARTIALREAPMSIX_r10b_H_
#define _PARTIALREAPMSIX_r10b_H_
...
public:
     ...
     */
    virtual PartialReapMSIX_r10b *Clone() const
        { return new PartialReapMSIX_r10b(*this); }
    PartialReapMSIX_r10b &operator=(const PartialReapMSIX_r10b &other);
    PartialReapMSIX_r10b(const PartialReapMSIX_r10b &other);
